                    ...
                    onCompleted: (String value) async {
                      ...
                      var response = await http.post(
                        ...
                        body: {
                          ...
                          "type": type,
                          "devicetokenkey":
                              "fTx6fz_mTpWCIcNKDyY2ko:APA91bEr-jgvpAe7kiZbyUAs0CXyhEoVSLZ_xDMvTzv57CQ3B5cZTkzVe2FWrvilzsfb11r9rvz7HV4cGS_FL1RpTowIkikwZoeUXvUsv1Wtb4tFhK7gKMZqZsZTIn_oo35cHuUl4v-N"
                        },
                        headers: {
                      ...
                      if (response.statusCode == 200) {
                        ...
                        if (data['success'] == true) {
                          ...
                          if (data['local_da_price'] != null) {
                            ...
                            prefs.setString('local_da_price', "");
                          }
                          prefs.setString(
                ...
                child: Align(
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      ...
                      var response =
                          await http.post(Uri.parse(URL + "app_login"), body: {
                        "auth_key": "VrdoCRJjhZMVcl3PIsNdM",
                        "mobile_no": _mobile,
                        "otp": "",
                      }, headers: {
