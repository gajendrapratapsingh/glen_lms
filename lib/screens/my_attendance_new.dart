...
class LocalDAListNew extends StatefulWidget {
  ...
  final String local_type;
  LocalDAListNew(this.recordName, this.local_type);
  @override
...
class _ResetPinState extends State<LocalDAListNew>
  ...
  _getUser() async {
    ...
    setState(() {
      ...
      if (widget.local_type != "") {
        _localDA = widget.local_type;
      }
      if (_localDA == "Per Km") {
  ...
  Future _leadData(String mon, String year) async {
    ...
    if (response.statusCode == 200) {
      ...
      if (data['local_DA_list'].length != 0) {
        setState(() {
          if (widget.recordName != "") {
            if (data['local_DA_list'][0]['sales_approved_expenses'] ==
                "Pending") {
              show = true;
            } else {
              show = false;
  ...
  Future _leadData1(String mon, String year) async {
    var response = await http.post(
      Uri.parse(URL + "localDAFixed_wise"),
      body: {
        "auth_key": "VrdoCRJjhZMVcl3PIsNdM",
        "id": widget.recordName != "" ? widget.recordName : _userId,
        "month": mon,
  ...
  Widget _emptyOrders() {
    return Center(
      child: Container(
          margin: EdgeInsets.only(top: 100), child: Text('NO RECORD FOUND!')),
    );
  }
                                            ...
                                            onChanged: (String newValue) {
                                              setState(() {
                                                ...
                                                if (_dropdownValue == "Jan") {
                                                  ...
                                                  if (_localDA == "Per Km") {
                                                    _leads =
                                                        _leadData(name, name1);
                                                  } else if (_localDA ==
                                                      "Fixed") {
                                                    _leads =
                                                        _leadData1(name, name1);
                                                  } else {
                                                    _leads =
                                                        _leadData2(name, name1);
                                                  }
                      ...
                      child: ButtonTheme(
                        ...
                        child: Container(
                          child: RaisedButton(
                            ...
                            onPressed: () async {
                              var response = await http.post(
                                Uri.parse(URL + "localDAbossapproved"),
                                body: {
                                  "auth_key": "VrdoCRJjhZMVcl3PIsNdM",
                                  "id": _userId.toString(),
                                  "month": name,
                                  "year": name1,
                                  "user_id": widget.recordName
                                },
                                headers: {
                                  "Accept": "application/json",
                                },
    ...
    return TableRow(
      ...
      children: [
        ...
        Container(
            ...
            child: Container(
                child: AutoSizeText(
                    result['total_hours'].toString() +
                        ":" +
                        result['total_minut'].toString(),
                    textAlign: TextAlign.center,
                    maxLines: 3,
                    style: TextStyle(color: Colors.black)))),
        InkWell(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.done) {
            ...
            return Column(children: <Widget>[
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                ...
                                children: <Widget>[
                                  Row(children: <Widget>[
                                    Expanded(
                                      child: snapshot.data['user_Km_price'] !=
                                              null
                                          ? Text(
                                              "Per Km Price: " +
                                                  "\u20B9 " +
                                                  snapshot.data['user_Km_price']
                                                      .toString(),
                                  ...
                                  Row(children: <Widget>[
                                    Expanded(
                                      child: Text(
                                          "Total Distance: " +
                                              snapshot.data['total_km_distance']
                                                  .toString(),
                                          overflow: TextOverflow.ellipsis,
                                          maxLines: 1,
                                          style: normalText),
                                  ...
                                  Row(children: <Widget>[
                                    Expanded(
                                      child: snapshot.data['mobile_expense'] !=
                                              null
                                          ? Text(
                                              "Mobile Expense: " +
                                                  snapshot
              ...
              snapshot.data['local_DA_list'].length != 0
                  ? Container(
