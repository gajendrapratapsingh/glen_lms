...
const String API_PATH = "/glen/public/api";
const String URL = "https://lms.glenindia.com/api/";
const String URL1 = "http://dev.techstreet.in/glen/public/api/";
...
final List<Draw> drawerItems = [
  ...
  Draw(title: 'Glen Promotion', icon: path + 'promotion.png'),
...
final List categories = [
  ...
  {'image': path + 'promotion.png', 'title': 'Glen Promotion'},
